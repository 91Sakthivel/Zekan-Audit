...
that a wrong split was used or that leakage occurred.  Zekan owns the evaluation
loop and cannot observe what split the caller applied outside of Zekan; the probe
...
_WHY = (
    ...
    "Zekan evaluates under the declared temporal/grouped contract, which avoids this."
)
...
def probe_entity_contamination_risk(
    ...
    return IssueRecord(
        ...
        next_fix=(
            "If running your own evaluation outside Zekan, use a split strategy "
