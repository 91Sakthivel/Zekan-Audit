...
from gotcha.benchmark.injectors import inject_graded_future_leak, inject_label_proxy
...
def _build_contract(forbidden_col: str, n_entities: int) -> tuple[PredictionContract, GotchaConfig]:
    ...
    return contract, GotchaConfig(contract=contract)
