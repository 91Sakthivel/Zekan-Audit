...
INVOCATION
----------
    python -m gotcha.benchmark.label_proxy_sweep
or
    python gotcha/benchmark/label_proxy_sweep.py
"""
...
def run_sweep(verbose: bool = True) -> list[ProxyRow]:
    contract = _contract()
    config = GotchaConfig(contract=contract)   # default SplitPolicy -- matches n=200 temporal baseline
