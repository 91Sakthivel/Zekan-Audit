...
from gotcha.contract.contract_checks import validate_contract
from gotcha.contract.prediction_contract import PredictionContract
from gotcha.severity.metrics import evaluate_folds
from gotcha.severity.splitters import random_grouped_folds, temporal_expanding_folds
...
def run_severity_analysis(
    ...
    if n_permutations > 0:
        ...
        from gotcha.severity.metrics import _default_model_factory
...
def leakage_issue_record(result: SeverityResult) -> "IssueRecord":
    ...
    """
    from gotcha.detectors.schema import Evidence, IssueRecord, IssueType
